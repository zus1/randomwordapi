...
final class AddApiLogTable extends AbstractMigration
{
    public function change(): void
    {
        $table = $this->table("log_api", ['id' => false, 'primary_key' => ["id"], 'engine' => "InnoDB", 'encoding' => "utf8", 'collation' => "utf8_general_ci", 'comment' => "", 'row_format' => "Dynamic"]);
